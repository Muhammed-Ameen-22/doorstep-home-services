            ...
            <form action="" method="POST">
              ...
              <div class="user-details">
                ...
                <div class="input-box">
                  ...
                  <input type="text" name="pincode" placeholder="Enter your Pincode" required value='.  $row['sp_pincode'].'>
                </div>
                <div class="input-box">
                  <span class="details">Email</span>
                  <input type="text" name="email" placeholder="Enter your email" required value='. $row['sp_username'].'>
                </div>
                <div class="input-box">
                  <span class="details">Phone Number</span>
                  <input type="text" name="phno" placeholder="Enter your number" required value='.  $row['sp_phone'].'>
                </div>
                <div class="input-box">
