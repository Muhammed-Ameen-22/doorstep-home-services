            ...
            <form action="" method="POST">
              ...
              <div class="user-details">
                <div class="input-box">
                  ...
                  <input type="text" name="fname" placeholder="Enter your first name" required value= '. $row['cust_fname'] .'>
                </div>
                <div class="input-box">
                  <span class="details">Last Name</span>
                  <input type="text" name="lname" placeholder="Enter your last name" required value='. $row['cust_lname'].'> 
                </div>
                <div class="input-box">
                  <span class="details">House</span>
                  <input type="text" name="house" placeholder="Enter your house name" required value= '. $row['cust_house'].'>
                </div>
                <div class="input-box">
                  <span class="details">City</span>
                  <input type="text" name="city" placeholder="Enter your city" required value='.  $row['cust_city'].'>
              </div>
                  <div class="input-box">
                      <span class="details">District</span>
                      <input type="text" name="district" placeholder="Enter your district" required value='.  $row['cust_dist'].'>
                    </div>
